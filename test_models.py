...
# Load the model
kitchen_model = load('kitchen_model.joblib')
kitchen_vec = load('kitchen_vec.joblib')
room_model = load('room_model.joblib')
room_vec = load('room_vec.joblib')
electrical_model = load('electrical_model.joblib')
electrical_vec = load('electrical_vec.joblib')
...
model_reply("12223", "nelshell", "kitchenDF", "leaky faucet")